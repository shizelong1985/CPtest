...
# TWO COMMON FACTORS r = 2
# DGP1_A -> sigma_E is diagonal with sigma_ei = 1
# DGP2_A -> sigma_E is diagonal with sigma_ei = 1 if i is odd and sigma_ei = 2 if i is even
# DGP3_A -> sigma_E is not diagonal (cross-section dependence) and diagonal elements sigma_ei = 1 if i is odd and sigma_ei = 2 if i is even
#
# DGP_B -> eit = theta * ei(t-1) + uit for i = 1,..,P theta N(0.5, 0.05)
#
# DGP1, DGP2, DGP3 two common factors
# A1, B1 two common factors with autoregressive coeff = 0.9 for F1 and 0.8 for F2
# A2, B2 two common factors with autoregressive coeff = 0.6 for F1 and 0.5 for F2
# A3, B3 two common factors with autoregressive coeff = 0.6 for F1 and 0.5 for F2 which error N(0,sd=0.5)
...
R <- r <- 2 # number of static factors (q=1 dynamic factor)
...
for (P in Pvector){
  ...
  saveRDS(resultsParallel, file = paste0("P", P, "_resultsDGP1_A1.RDS"))
}
...
for (P in Pvector){
  ...
  saveRDS(resultsParallel, file = paste0("P", P, "_resultsDGP2_A1.RDS"))
}
...
for (P in Pvector){
  ...
  saveRDS(resultsParallel, file = paste0("P", P, "_resultsDGP3_A1.RDS"))
}
...
for (P in Pvector){
  ...
  saveRDS(resultsParallel, file = paste0("P", P, "_resultsDGP1_B1.RDS"))
}
...
for (P in Pvector){
  ...
  resultsParallel <- foreach(i = 1:nrow(sample), .verbose = TRUE, .inorder = TRUE) %dopar% {
    ...
    for (j in 1:iteration){
      ...
      u <- mvrnorm(n = N, rep(0, P), CovMatrix) # normal (0,1) errores del ruido
      E <- matrix(0,N,P)
      for (m in 1:(P/2)){
        for (n in 2:N){
          phi <- 0.5 + rnorm(1, 0, 0.05)
  ...
  saveRDS(resultsParallel, file = paste0("P", P, "_resultsDGP2_B1.RDS"))
}
...
for (P in Pvector){
  ...
  saveRDS(resultsParallel, file = paste0("P", P, "_resultsDGP3_B1.RDS"))
}
...
for (P in Pvector){
  ...
  saveRDS(resultsParallel, file = paste0("P", P, "_resultsDGP1_A2.RDS"))
}
...
for (P in Pvector){
  ...
  saveRDS(resultsParallel, file = paste0("P", P, "_resultsDGP2_A2.RDS"))
}
...
for (P in Pvector){
  ...
  saveRDS(resultsParallel, file = paste0("P", P, "_resultsDGP3_A2.RDS"))
}
...
for (P in Pvector){
  ...
  saveRDS(resultsParallel, file = paste0("P", P, "_resultsDGP1_B2.RDS"))
}
...
for (P in Pvector){
  ...
  saveRDS(resultsParallel, file = paste0("P", P, "_resultsDGP2_B2.RDS"))
}
...
for (P in Pvector){
  ...
  saveRDS(resultsParallel, file = paste0("P", P, "_resultsDGP3_B2.RDS"))
}
...
for (P in Pvector){
  ...
  saveRDS(resultsParallel, file = paste0("P", P, "_resultsDGP1_A3.RDS"))
}
...
for (P in Pvector){
  ...
  saveRDS(resultsParallel, file = paste0("P", P, "_resultsDGP2_A3.RDS"))
}
...
for (P in Pvector){
  ...
  saveRDS(resultsParallel, file = paste0("P", P, "_resultsDGP3_A3.RDS"))
}
...
for (P in Pvector){
  ...
  saveRDS(resultsParallel, file = paste0("P", P, "_resultsDGP1_B3.RDS"))
}
...
for (P in Pvector){
  ...
  saveRDS(resultsParallel, file = paste0("P", P, "_resultsDGP2_B3.RDS"))
}
...
for (P in Pvector){
  ...
  saveRDS(resultsParallel, file = paste0("P", P, "_resultsDGP3_B3.RDS"))
}
